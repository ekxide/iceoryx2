...
#[inventory_test_generic(RelocatableVec<u64>, RelocatableVec<u128>, RelocatableVec<[u8; 123]>, RelocatableQueue<u64>, RelocatableQueue<u128>, RelocatableQueue<[u8; 123]>, Container<u64>, Container<u128>, Container<[u8; 123]>, UniqueIndexSet, RelocatableIndexQueue, RelocatableSafelyOverflowingIndexQueue, RelocatableUsedChunkList)]
