...
fn ffi_settings_are_equal_to_iceoryx2_settings() {
    ...
    assert_that!(IOX2_IS_IPC_LISTENER_FD_BASED, eq <<<ipc::Service as iceoryx2::service::Service>::Event as iceoryx2_cal::event::Event<RelocatableCountingBitSetEventState>>::Listener as iceoryx2_cal::event::Listener<RelocatableCountingBitSetEventState>>::IS_FILE_DESCRIPTOR_BASED);
    assert_that!(IOX2_IS_LOCAL_LISTENER_FD_BASED, eq <<<local::Service as iceoryx2::service::Service>::Event as iceoryx2_cal::event::Event<RelocatableCountingBitSetEventState>>::Listener as iceoryx2_cal::event::Listener<RelocatableCountingBitSetEventState>>::IS_FILE_DESCRIPTOR_BASED);
