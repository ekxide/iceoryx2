...
#[repr(C)]
#[iceoryx2_ffi(UniquePublisherId)]
pub struct iox2_unique_publisher_id_t {
    pub value: iox2_unique_publisher_id_storage_t,
    pub(super) deleter: fn(*mut iox2_unique_publisher_id_t),
}

impl iox2_unique_publisher_id_t {
    pub(super) fn init(
        &mut self,
        value: UniquePublisherId,
        deleter: fn(*mut iox2_unique_publisher_id_t),
    ) {
