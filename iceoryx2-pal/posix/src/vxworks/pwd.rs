...
pub unsafe fn getpwnam_r(
    ...
    unsafe { internal::getpwnam_r(name, pwd, buf, buflen, result) }
}
...
pub unsafe fn getpwuid_r(
    ...
    unsafe { internal::getpwuid_r(uid, pwd, buf, buflen, result) }
}
...
pub unsafe fn getgrnam_r(
    ...
    // unsafe { libc::getgrnam_r(name, grp, buf, buflen, result) }
