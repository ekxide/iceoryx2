...
pub unsafe fn timer_create(
    ...
    unsafe { internal::timer_create(clock_id, sevp, timer_id) }
}

pub unsafe fn timer_delete(timer_id: timer_t) -> int {
    unsafe { internal::timer_delete(timer_id) }
}
...
pub unsafe fn timer_settime(
    ...
    unsafe { internal::timer_settime(timer_id, flags, new_value, old_value) }
}

pub unsafe fn timer_gettime(timer_id: timer_t, current_value: *mut itimerspec) -> int {
    unsafe { internal::timer_gettime(timer_id, current_value) }
}
